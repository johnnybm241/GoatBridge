...
const SIZE_CLASSES = {
  ...
  // Used for kibitzing, where nobody needs room for a bidding box or controls.
  xl: 'w-12 h-16 sm:w-14 sm:h-20 md:w-20 md:h-28 lg:w-24 lg:h-32 xl:w-28 xl:h-40 text-sm md:text-base lg:text-lg',
};
